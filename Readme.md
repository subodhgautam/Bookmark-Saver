...
*IMAGE: BOOKMARK SAVER* 

## Installation:
1. Clone the repository:
    ```bash
    git clone https://github.com/subodhgautam/Bookmark-Saver.git
    ```

2. Navigate to `index.html` file to open in your browser to view the App.

   ## OR
    You can visit the site <a href="https://subodhgautam.github.io/Bookmark-Saver/src/index.html">here.</a> 